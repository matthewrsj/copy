...
const (
	...
	// State indicating Terminal is ready to be unloaded and reloaded in terminal.
	UnloadOperationState_PreparedToReload UnloadOperationState = 4
)
...
type UnloadOperation struct {
	...
	// Destination is provided by terminal, when it requests that a payload be reloaded.
...
func (m *UnloadOperation) GetDestination() *Location {
	if m != nil {
...
var fileDescriptor_ff8b8260c8ef16ad = []byte{
	...
	,
}
