...
const (
	...
	FixtureControlSmState_FXR_ST_SEQ_PAUSED       FixtureControlSmState = 12
	FixtureControlSmState_FXR_ST_UPDATING         FixtureControlSmState = 13
	FixtureControlSmState_FXR_ST_CLOSED_WAIT      FixtureControlSmState = 14
	FixtureControlSmState_FXR_ST_FAULTED_OPEN_REQ FixtureControlSmState = 15
)
...
var (
	FixtureControlSmState_name = map[int32]string{
		...
		11: "FXR_ST_FAULTED",
		12: "FXR_ST_SEQ_PAUSED",
		13: "FXR_ST_UPDATING",
		14: "FXR_ST_CLOSED_WAIT",
		15: "FXR_ST_FAULTED_OPEN_REQ",
	}
	FixtureControlSmState_value = map[string]int32{
		...
		"FXR_ST_FAULTED":          11,
		"FXR_ST_SEQ_PAUSED":       12,
		"FXR_ST_UPDATING":         13,
		"FXR_ST_CLOSED_WAIT":      14,
		"FXR_ST_FAULTED_OPEN_REQ": 15,
	}
)
...
const (
	...
	EquipmentRequest_EQUIPMENT_REQUEST_MAINTENANCE_FW_VERSION         EquipmentRequest = 5 // request maintenance if firmware is out of date
	EquipmentRequest_EQUIPMENT_REQUEST_MAINTENANCE_TRAY_SENSOR        EquipmentRequest = 6 // request maintenance for tray sensor issue
	EquipmentRequest_EQUIPMENT_REQUEST_MAINTENANCE_FXR_NOT_RESPONDING EquipmentRequest = 7 // fixture not responding or unexpected info
)
...
var (
	EquipmentRequest_name = map[int32]string{
		...
		5: "EQUIPMENT_REQUEST_MAINTENANCE_FW_VERSION",
		6: "EQUIPMENT_REQUEST_MAINTENANCE_TRAY_SENSOR",
		7: "EQUIPMENT_REQUEST_MAINTENANCE_FXR_NOT_RESPONDING",
	}
	EquipmentRequest_value = map[string]int32{
		...
		"EQUIPMENT_REQUEST_MAINTENANCE_FW_VERSION":         5,
		"EQUIPMENT_REQUEST_MAINTENANCE_TRAY_SENSOR":        6,
		"EQUIPMENT_REQUEST_MAINTENANCE_FXR_NOT_RESPONDING": 7,
	}
)
...
type MaintenanceReason int32

const (
	MaintenanceReason_MAINTENANCE_REASON_UNKNOWN_UNSPECIFIED  MaintenanceReason = 0
	MaintenanceReason_MAINTENANCE_REASON_FAILED_COMMISSIONING MaintenanceReason = 1 // Failed commissioning
	MaintenanceReason_MAINTENANCE_REASON_FIRMWARE_VERSION     MaintenanceReason = 2 // Firmware version is not compliant with line requirements
	MaintenanceReason_MAINTENANCE_REASON_TRAY_SENSOR          MaintenanceReason = 3 // Tray present sensor needs maintenance
	MaintenanceReason_MAINTENANCE_REASON_FAN_FAULTED          MaintenanceReason = 4 // Fan faulted
	MaintenanceReason_MAINTENANCE_REASON_ENUMERATION_CHANGED  MaintenanceReason = 5 // Enumeration change
	MaintenanceReason_MAINTENANCE_REASON_FXR_NOT_RESPONDING   MaintenanceReason = 6 // fixture not responding
)

// Enum value maps for MaintenanceReason.
var (
	MaintenanceReason_name = map[int32]string{
		0: "MAINTENANCE_REASON_UNKNOWN_UNSPECIFIED",
		1: "MAINTENANCE_REASON_FAILED_COMMISSIONING",
		2: "MAINTENANCE_REASON_FIRMWARE_VERSION",
		3: "MAINTENANCE_REASON_TRAY_SENSOR",
		4: "MAINTENANCE_REASON_FAN_FAULTED",
		5: "MAINTENANCE_REASON_ENUMERATION_CHANGED",
		6: "MAINTENANCE_REASON_FXR_NOT_RESPONDING",
	}
	MaintenanceReason_value = map[string]int32{
		"MAINTENANCE_REASON_UNKNOWN_UNSPECIFIED":  0,
		"MAINTENANCE_REASON_FAILED_COMMISSIONING": 1,
		"MAINTENANCE_REASON_FIRMWARE_VERSION":     2,
		"MAINTENANCE_REASON_TRAY_SENSOR":          3,
		"MAINTENANCE_REASON_FAN_FAULTED":          4,
		"MAINTENANCE_REASON_ENUMERATION_CHANGED":  5,
		"MAINTENANCE_REASON_FXR_NOT_RESPONDING":   6,
	}
)

func (x MaintenanceReason) Enum() *MaintenanceReason {
	p := new(MaintenanceReason)
	*p = x
	return p
}

func (x MaintenanceReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MaintenanceReason) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_proto_enumTypes[5].Descriptor()
}

func (MaintenanceReason) Type() protoreflect.EnumType {
	return &file_enums_proto_enumTypes[5]
}

func (x MaintenanceReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MaintenanceReason.Descriptor instead.
func (MaintenanceReason) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	FormRequest_FORM_REQUEST_COMPLETE            FormRequest = 7 // Complete the active recipe
	FormRequest_FORM_REQUEST_FAULT               FormRequest = 8 // Fault the fixture
)
...
var (
	FormRequest_name = map[int32]string{
		...
		7: "FORM_REQUEST_COMPLETE",
		8: "FORM_REQUEST_FAULT",
	}
	FormRequest_value = map[string]int32{
		...
		"FORM_REQUEST_COMPLETE":            7,
		"FORM_REQUEST_FAULT":               8,
	}
)
...
const (
	...
	StibDCDCState_STIB_DCDC_STATE_INTERNAL_SLOSH           StibDCDCState = 9
	StibDCDCState_STIB_DCDC_STATE_VOLTAGE_CONTROL          StibDCDCState = 10
)
...
var (
	StibDCDCState_name = map[int32]string{
		...
		9:  "STIB_DCDC_STATE_INTERNAL_SLOSH",
		10: "STIB_DCDC_STATE_VOLTAGE_CONTROL",
	}
	StibDCDCState_value = map[string]int32{
		...
		"STIB_DCDC_STATE_INTERNAL_SLOSH":           9,
		"STIB_DCDC_STATE_VOLTAGE_CONTROL":          10,
	}
)
...
const (
	...
	StibFormState_STIB_FORM_STATE_PRE_CHECK                StibFormState = 13
	StibFormState_STIB_FORM_STATE_POST_CHECK               StibFormState = 14
	StibFormState_STIB_FORM_STATE_POWER_SUPPLY             StibFormState = 15
)
...
var (
	StibFormState_name = map[int32]string{
		...
		13: "STIB_FORM_STATE_PRE_CHECK",
		14: "STIB_FORM_STATE_POST_CHECK",
		15: "STIB_FORM_STATE_POWER_SUPPLY",
	}
	StibFormState_value = map[string]int32{
		...
		"STIB_FORM_STATE_PRE_CHECK":                13,
		"STIB_FORM_STATE_POST_CHECK":               14,
		"STIB_FORM_STATE_POWER_SUPPLY":             15,
	}
)
...
const (
	...
	CellStatus_CELL_STATUS_FAILED_SAFETY_LIMIT        CellStatus = 5 // failure at cell level
	CellStatus_CELL_STATUS_FAILED_POGO_PIN_IRRATIONAL CellStatus = 6
	CellStatus_CELL_STATUS_COMPLETE_WARNING           CellStatus = 7
	CellStatus_CELL_STATUS_FAILED_SAFETY_LEVEL2       CellStatus = 8  // failure at tray level
	CellStatus_CELL_STATUS_FAILED_SAFETY_LEVEL3       CellStatus = 9  // failure at fire? level : TODO: check what this is??
	CellStatus_CELL_STATUS_IN_PROCESS_WARNING         CellStatus = 10 // cell is still in process, but warning present
)
...
var (
	CellStatus_name = map[int32]string{
		...
		7:  "CELL_STATUS_COMPLETE_WARNING",
		8:  "CELL_STATUS_FAILED_SAFETY_LEVEL2",
		9:  "CELL_STATUS_FAILED_SAFETY_LEVEL3",
		10: "CELL_STATUS_IN_PROCESS_WARNING",
	}
	CellStatus_value = map[string]int32{
		...
		"CELL_STATUS_COMPLETE_WARNING":           7,
		"CELL_STATUS_FAILED_SAFETY_LEVEL2":       8,
		"CELL_STATUS_FAILED_SAFETY_LEVEL3":       9,
		"CELL_STATUS_IN_PROCESS_WARNING":         10,
	}
)
...
// RECIPE PARAMETERS
type ParamLimitType int32

const (
	ParamLimitType_PARAM_LIMIT_TYPE_UNKNOWN_UNSPECIFIED ParamLimitType = 0
	ParamLimitType_PARAM_LIMIT_TYPE_VOLTAGE             ParamLimitType = 1
	ParamLimitType_PARAM_LIMIT_TYPE_TEMPERATURE         ParamLimitType = 2
	ParamLimitType_PARAM_LIMIT_TYPE_TIME                ParamLimitType = 3
	ParamLimitType_PARAM_LIMIT_TYPE_CAPACITY            ParamLimitType = 4
	ParamLimitType_PARAM_LIMIT_TYPE_DVDT                ParamLimitType = 5
	ParamLimitType_PARAM_LIMIT_TYPE_DVDQ                ParamLimitType = 6
)

// Enum value maps for ParamLimitType.
var (
	ParamLimitType_name = map[int32]string{
		0: "PARAM_LIMIT_TYPE_UNKNOWN_UNSPECIFIED",
		1: "PARAM_LIMIT_TYPE_VOLTAGE",
		2: "PARAM_LIMIT_TYPE_TEMPERATURE",
		3: "PARAM_LIMIT_TYPE_TIME",
		4: "PARAM_LIMIT_TYPE_CAPACITY",
		5: "PARAM_LIMIT_TYPE_DVDT",
		6: "PARAM_LIMIT_TYPE_DVDQ",
	}
	ParamLimitType_value = map[string]int32{
		"PARAM_LIMIT_TYPE_UNKNOWN_UNSPECIFIED": 0,
		"PARAM_LIMIT_TYPE_VOLTAGE":             1,
		"PARAM_LIMIT_TYPE_TEMPERATURE":         2,
		"PARAM_LIMIT_TYPE_TIME":                3,
		"PARAM_LIMIT_TYPE_CAPACITY":            4,
		"PARAM_LIMIT_TYPE_DVDT":                5,
		"PARAM_LIMIT_TYPE_DVDQ":                6,
	}
)

func (x ParamLimitType) Enum() *ParamLimitType {
	p := new(ParamLimitType)
	*p = x
	return p
}

func (x ParamLimitType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ParamLimitType) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_proto_enumTypes[22].Descriptor()
}

func (ParamLimitType) Type() protoreflect.EnumType {
	return &file_enums_proto_enumTypes[22]
}

func (x ParamLimitType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ParamLimitType.Descriptor instead.
func (ParamLimitType) EnumDescriptor() ([]byte, []int) {
	return file_enums_proto_rawDescGZIP(), []int{22}
}

type ParamLimitActive int32

const (
	ParamLimitActive_PARAM_LIMIT_ACTIVE_UNKNOWN_UNSPECIFIED ParamLimitActive = 0
	ParamLimitActive_PARAM_LIMIT_ACTIVE_BEFORE              ParamLimitActive = 1
	ParamLimitActive_PARAM_LIMIT_ACTIVE_DURING              ParamLimitActive = 2
	ParamLimitActive_PARAM_LIMIT_ACTIVE_AFTER               ParamLimitActive = 3
)

// Enum value maps for ParamLimitActive.
var (
	ParamLimitActive_name = map[int32]string{
		0: "PARAM_LIMIT_ACTIVE_UNKNOWN_UNSPECIFIED",
		1: "PARAM_LIMIT_ACTIVE_BEFORE",
		2: "PARAM_LIMIT_ACTIVE_DURING",
		3: "PARAM_LIMIT_ACTIVE_AFTER",
	}
	ParamLimitActive_value = map[string]int32{
		"PARAM_LIMIT_ACTIVE_UNKNOWN_UNSPECIFIED": 0,
		"PARAM_LIMIT_ACTIVE_BEFORE":              1,
		"PARAM_LIMIT_ACTIVE_DURING":              2,
		"PARAM_LIMIT_ACTIVE_AFTER":               3,
	}
)

func (x ParamLimitActive) Enum() *ParamLimitActive {
	p := new(ParamLimitActive)
	*p = x
	return p
}

func (x ParamLimitActive) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ParamLimitActive) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_proto_enumTypes[23].Descriptor()
}

func (ParamLimitActive) Type() protoreflect.EnumType {
	return &file_enums_proto_enumTypes[23]
}

func (x ParamLimitActive) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ParamLimitActive.Descriptor instead.
func (ParamLimitActive) EnumDescriptor() ([]byte, []int) {
...
var file_enums_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2a, 0x90, 0x03,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x44, 0x10, 0x04, 0x2a, 0xef, 0x02, 0x0a, 0x10, 0x45, 0x71, 0x75, 0x69, 0x70, 0x6d, 0x65,
	0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x25, 0x45, 0x51, 0x55,
	0x49, 0x50, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x45, 0x53, 0x54, 0x5f, 0x55,
	...
	,
	...
	,
	...
	0x0a, 0x1c, 0x49, 0x53, 0x4f, 0x4c, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x45, 0x53, 0x54,
	0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x01,
	0x12, 0x22, 0x0a, 0x1e, 0x49, 0x53, 0x4f, 0x4c, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x45,
	0x53, 0x54, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x49, 0x4e, 0x41, 0x43, 0x54, 0x49,
	0x56, 0x45, 0x10, 0x02, 0x12, 0x21, 0x0a, 0x1d, 0x49, 0x53, 0x4f, 0x4c, 0x41, 0x54, 0x49, 0x4f,
	0x4e, 0x5f, 0x54, 0x45, 0x53, 0x54, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x41,
	0x55, 0x4c, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x87, 0x01, 0x0a, 0x08, 0x49, 0x73, 0x6f, 0x53,
	...
	,
	...
	,
	...
	0x41, 0x55, 0x4c, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x93, 0x01, 0x0a, 0x0a, 0x54, 0x61, 0x75,
	0x78, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x23, 0x0a, 0x1f, 0x54, 0x41, 0x55, 0x58, 0x5f,
	...
	,
...
var file_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_enums_proto_goTypes = []interface{}{
	...
	(MaintenanceReason)(0),      // 5: MaintenanceReason
	(EquipmentStatus)(0),        // 6: EquipmentStatus
	(FireAlarmStatus)(0),        // 7: FireAlarmStatus
	(FormRequest)(0),            // 8: FormRequest
	(IsolationTestRequest)(0),   // 9: IsolationTestRequest
	(IsolationTestStatus)(0),    // 10: IsolationTestStatus
	(IsoState)(0),               // 11: IsoState
	(IsoError)(0),               // 12: IsoError
	(EnumerationStatus)(0),      // 13: EnumerationStatus
	(TrayOrientation)(0),        // 14: TrayOrientation
	(StibDCDCState)(0),          // 15: StibDCDCState
	(StibFormState)(0),          // 16: StibFormState
	(CellStatus)(0),             // 17: CellStatus
	(CellDetectStatus)(0),       // 18: CellDetectStatus
	(ShuntCalStatus)(0),         // 19: ShuntCalStatus
	(FanStatus)(0),              // 20: FanStatus
	(TauxStatus)(0),             // 21: TauxStatus
	(ParamLimitType)(0),         // 22: ParamLimitType
	(ParamLimitActive)(0),       // 23: ParamLimitActive
}
